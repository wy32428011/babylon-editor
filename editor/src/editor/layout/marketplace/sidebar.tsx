				...
				<div className="flex-1 flex flex-col gap-2 bg-secondary dark:bg-secondary/35 p-2 rounded-lg">
						...
						<div className="flex flex-col gap-2">
							<div className="flex items-center gap-2">
								<div className="flex flex-col gap-1 w-full">
									<span className="text-xs uppercase font-bold text-muted-foreground tracking-widest px-2">质量</span>
								...
								<div className="flex flex-col gap-1 w-full">
									<span className="text-xs uppercase font-bold text-muted-foreground tracking-widest px-2">格式</span>
					...
					{!hasDownloadOptions && props.asset.marketplaceUrl && (
						<div className="flex gap-2 bg-secondary dark:bg-secondary/35 p-2 rounded-lg">
							...
							>
								{props.asset.marketplaceActionLabel || (props.asset.isDownloadable === false ? "查看/购买" : "在资源市场中打开")}
							</Button>
					...
					<div className="flex flex-col gap-4 text-sm">
						{props.asset.author && (
							<div className="flex flex-col">
								<span className="text-[11px] uppercase font-bold text-muted-foreground tracking-widest mb-0.5">作者</span>
								<div
						...
						{props.asset.license && (
							<div className="flex flex-col">
								<span className="text-[11px] uppercase font-bold text-muted-foreground tracking-widest mb-0.5">许可证</span>
						...
						{props.asset.description && (
							<div className="flex flex-col">
								<span className="text-[11px] uppercase font-bold text-muted-foreground tracking-widest mb-0.5">描述</span>
						...
						{props.asset.tags?.length && (
							<div className="flex flex-col">
								<span className="text-[11px] uppercase font-bold text-muted-foreground tracking-widest mb-1.5">标签</span>
