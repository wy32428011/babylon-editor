	...
	public render(): ReactNode {
		return (
			<>
				...
				<EditorInspectorSectionField title="水">
					<EditorInspectorTextureField hideLevel object={this.props.material} title="Normal Texture" property="bumpTexture" onChange={() => this.forceUpdate()}>
						<EditorInspectorNumberField label="凹凸高度" object={this.props.material} property="bumpHeight" />
				...
				{this.props.material.bumpTexture && (
					<>
						<EditorInspectorSectionField title="颜色">
							...
							<EditorInspectorColorField label={<div className="w-14">高光</div>} object={this.props.material} property="specularColor" />
						</EditorInspectorSectionField>

						<EditorInspectorSectionField title="反射">
							<input
								type="text"
								placeholder="搜索..."
				...
				<EditorInspectorSectionField title="Options">
					<EditorInspectorNumberField label="波长" object={this.props.material} property="waveLength" />

					<EditorInspectorNumberField label="风力" object={this.props.material} property="windForce" />
					<EditorInspectorVectorField label="风向" object={this.props.material} property="windDirection" step={0.1} />

					<EditorInspectorSwitchField label="叠加凹凸" object={this.props.material} property="bumpSuperimpose" />
					<EditorInspectorSwitchField label="Fresnel Separate" object={this.props.material} property="fresnelSeparate" />
					<EditorInspectorSwitchField label="凹凸影响反射" object={this.props.material} property="bumpAffectsReflection" />
				</EditorInspectorSectionField>
