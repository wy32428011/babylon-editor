...
export class EditorSpriteManagerNodeInspector extends Component<IEditorInspectorImplementationProps<SpriteManagerNode>, IEditorSpriteManagerNodeInspectorState> {
	...
	public render(): ReactNode {
		return (
			<>
				...
				<EditorInspectorSectionField title="资源">
					<ToggleGroup
						type="single"
						className="w-full"
	...
	private _getCommonSpriteManagerInspector(): ReactNode {
		...
		return (
			<EditorInspectorSectionField title="精灵管理器">
				...
				<EditorInspectorListField
					...
					items={[
						...
						{ text: "添加", value: Constants.ALPHA_ADD },
				...
				<EditorInspectorSwitchField object={this.props.object.spriteManager} property="useLogarithmicDepth" label="使用对数深度" />
			</EditorInspectorSectionField>
		);
	}
