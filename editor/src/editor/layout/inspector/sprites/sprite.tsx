...
export class EditorSpriteInspector extends Component<IEditorInspectorImplementationProps<Sprite>, IEditorSpriteInspectorState> {
	...
	public render(): ReactNode {
		return (
			<>
				...
				<EditorInspectorSectionField title="精灵">
					<EditorInspectorNumberField object={this.props.object} property="angle" label="角度" asDegrees onFinishChange={() => this.forceUpdate()} />
					...
					<EditorInspectorColorField object={this.props.object} property="color" label="颜色" />
				</EditorInspectorSectionField>
	...
	private _getSpriteAnimationsInspector(): ReactNode {
		...
		return (
			<EditorInspectorSectionField title="动画">
				...
				{this.state.selectedAnimation && (
					<>
						...
						<EditorInspectorStringField object={this.state.selectedAnimation} property="name" label="名称" onChange={() => this.forceUpdate()} />
