...
export class EditorMeshInspector extends Component<IEditorInspectorImplementationProps<AbstractMesh>, IEditorMeshInspectorState> {
			...
			<>
				...
				{this.props.object.geometry && (
					<EditorInspectorSectionField title="杂项">
						...
						<EditorInspectorSwitchField label="始终选为活动网格" object={this.props.object} property="alwaysSelectAsActiveMesh" />
					</EditorInspectorSectionField>
				)}
	...
	private _getMaterialComponent(): ReactNode {
		...
		if (!this.props.object.material) {
			return (
				<EditorInspectorSectionField title="材质">
					<div
					...
					>
						<div className="text-center">
							<div className="text-xl mb-2">无材质</div>
						...
						<div className="flex gap-2">
							<DropdownMenu>
								...
								<DropdownMenuContent>
									...
									<DropdownMenuSub>
										<DropdownMenuSubTrigger>材质库</DropdownMenuSubTrigger>
										<DropdownMenuSubContent>
