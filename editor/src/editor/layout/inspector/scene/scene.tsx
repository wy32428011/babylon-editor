...
export class EditorSceneInspector extends Component<IEditorInspectorImplementationProps<Scene>, IEditorSceneInspectorState> {
		...
		return (
			<>
				<EditorInspectorSectionField title="颜色">
					...
					<EditorInspectorColorField object={this.props.object} property="ambientColor" label={<div className="w-14">环境光</div>} />
				...
				<EditorInspectorSectionField title="Fog">
					<EditorInspectorSwitchField object={this.props.object} property="fogEnabled" label="启用" onChange={() => this.forceUpdate()} />
					...
					{this.props.object.fogEnabled && (
						<>
							<EditorInspectorListField
								...
								label="模式"
								items={[
									{ text: "无", value: Scene.FOGMODE_NONE },
							...
							{this.props.object.fogMode === Scene.FOGMODE_LINEAR && (
								<>
									<EditorInspectorNumberField object={this.props.object} property="fogStart" label="开始" />
									<EditorInspectorNumberField object={this.props.object} property="fogEnd" label="结束" />
								</>
							)}
							...
							<EditorInspectorColorField object={this.props.object} property="fogColor" label="颜色" />
						</>
					)}
				</EditorInspectorSectionField>
	...
	private _getPhysicsComponent(): ReactNode {
		...
		return (
			<EditorInspectorSectionField title="物理">
				...
				{defaultRenderingPipeline && (
					<>
						<EditorInspectorSectionField title="Image Processing">
							<EditorInspectorSwitchField object={defaultRenderingPipeline} property="imageProcessingEnabled" label="启用" onChange={() => this.forceUpdate()} />
								...
								<EditorInspectorSectionField title="Color Curves">
									...
									{defaultRenderingPipeline.imageProcessing.colorCurvesEnabled && (
										<>
											...
											<div className="text-xl font-semibold px-2 text-center">阴影</div>
											<EditorInspectorSliderField
												object={defaultRenderingPipeline.imageProcessing.colorCurves}
												property="shadowsHue"
												min={0}
						...
						<EditorInspectorSectionField title="Bloom">
							<EditorInspectorSwitchField object={defaultRenderingPipeline} property="bloomEnabled" label="启用" onChange={() => this.forceUpdate()} />
						...
						<EditorInspectorSectionField title="Sharpen">
							<EditorInspectorSwitchField object={defaultRenderingPipeline} property="sharpenEnabled" label="启用" onChange={() => this.forceUpdate()} />
						...
						<EditorInspectorSectionField title="Grain">
							<EditorInspectorSwitchField object={defaultRenderingPipeline} property="grainEnabled" label="启用" onChange={() => this.forceUpdate()} />
							{defaultRenderingPipeline.grainEnabled && (
								<>
									<EditorInspectorNumberField object={defaultRenderingPipeline.grain} property="intensity" label="强度" />
									<EditorInspectorSwitchField object={defaultRenderingPipeline.grain} property="animated" label="动画" />
								</>
							)}
						</EditorInspectorSectionField>

						<EditorInspectorSectionField title="Depth-of-field">
							<EditorInspectorSwitchField object={defaultRenderingPipeline} property="depthOfFieldEnabled" label="启用" onChange={() => this.forceUpdate()} />
								...
								{defaultRenderingPipeline.imageProcessing.vignetteEnabled && (
									<>
										<EditorInspectorNumberField
											...
											min={0}
										/>
										<EditorInspectorColorField object={defaultRenderingPipeline.imageProcessing} property="vignetteColor" label="颜色" />
									</>
								)}
							</EditorInspectorSectionField>
						)}
						...
						<EditorInspectorSectionField title="Chromatic Aberration">
							...
							{defaultRenderingPipeline.chromaticAberrationEnabled && (
								<>
									...
									<EditorInspectorVectorField object={defaultRenderingPipeline.chromaticAberration} property="centerPosition" label="中心" />
								</>
							)}
						</EditorInspectorSectionField>

						<EditorInspectorSectionField title="Glow Layer">
							<EditorInspectorSwitchField object={defaultRenderingPipeline} property="glowLayerEnabled" label="启用" onChange={() => this.forceUpdate()} />

							{defaultRenderingPipeline.glowLayerEnabled && defaultRenderingPipeline.glowLayer && (
								<>
									<EditorInspectorNumberField object={defaultRenderingPipeline.glowLayer} property="intensity" label="强度" step={0.01} min={0} />
									<EditorInspectorNumberField
			...
			<EditorInspectorSectionField title="Temporal Anti-aliasing (TAA)">
				...
				{taaRenderingPipeline && (
					<>
						...
						<EditorInspectorSwitchField object={taaRenderingPipeline} property="clampHistory" label="钳制历史" />
		...
		return (
			<EditorInspectorSectionField title="SSAO2">
				...
				{ssao2RenderingPipeline && (
					<>
						<EditorInspectorNumberField object={ssao2RenderingPipeline} property="radius" label="半径" />
			...
			<EditorInspectorSectionField title="Reflections">
				...
				{ssrRenderingPipeline && (
					<>
						...
						<EditorInspectorNumberField object={ssrRenderingPipeline} property="thickness" label="厚度" />
						<EditorInspectorNumberField object={ssrRenderingPipeline} property="strength" label="强度" min={0} />
						<EditorInspectorNumberField
		...
		return (
			<EditorInspectorSectionField title="IBL Shadows">
				...
				{iblShadowsRenderPipeline && (
					<>
						<EditorInspectorNumberField object={iblShadowsRenderPipeline} property="shadowRemanence" label="阴影残留" min={0} max={1} />
						<EditorInspectorNumberField object={iblShadowsRenderPipeline} property="shadowOpacity" label="阴影不透明度" min={0} max={1} />
