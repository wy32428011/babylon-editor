...
export function EditorInspectorAssetField(props: IEditorInspectorAssetFieldProps) {
	...
	async function handleDrop(ev: DragEvent<HTMLDivElement>) {
		...
		if (props.assetType === "nodeParticleSystemSet" && extension !== ".npss") {
			return showAlert("Can't assign asset", "Only 节点粒子系统 Set files (.npss) are supported.");
		}
	...
	return (
		<div className="flex gap-2 items-center px-2">
			...
			<div
                ...
                `}
			>
				<div className="flex-1 text-center text-ellipsis overflow-hidden whitespace-nowrap">{value ? basename(value) : "无"}</div>
