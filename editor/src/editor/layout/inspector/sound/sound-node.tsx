	...
	public render(): ReactNode {
		return (
			<>
				...
				<EditorInspectorSectionField title="声音">
	...
	private _getSoundInspector(): ReactNode {
		...
		return (
			<>
				...
				<EditorInspectorNumberField object={this.props.object} property="volume" label="音量" step={0.01} min={0} max={1} />
				<EditorInspectorSwitchField object={this.props.object} property="isSpatial" label="空间音频" onChange={() => this.forceUpdate()} />

				{this.props.object.isSpatial && sound.spatial && (
					<>
						<EditorInspectorSwitchField object={this.props.object} property="autoUpdateSpatial" label="自动更新空间音频" onChange={() => this.forceUpdate()} />
