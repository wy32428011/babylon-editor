		...
		return (
			<>
				...
				<EditorInspectorSectionField title="浅色">
					...
					<EditorInspectorNumberField asDegrees label="角度" object={this.props.object} property="angle" min={0} max={Math.PI} step={0.1} />
				...
				<EditorLightShadowsInspector editor={this.props.editor} light={this.props.object} onShadowGeneratorChanged={() => this.forceUpdate()}>
					<EditorInspectorNumberField label="角度" object={this.props.object} property="shadowAngleScale" min={0} max={Math.PI * 2} />
