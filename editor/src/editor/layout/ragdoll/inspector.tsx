...
export class RagdollEditorInspector extends Component<IRagdollEditorInspectorProps, IRagdollEditorInspectorState> {
	...
	private _getRagdollInspector(): ReactNode {
		...
		return (
			<EditorInspectorSectionField title="布娃娃">
				<EditorInspectorListField noUndoRedo object={this} property="_selectedSkeleton" label="骨骼" items={skeletons ?? []} onChange={() => this._handleChange()} />
	...
	private _getConfigurationInspector(): ReactNode {
		...
		return (
			<EditorInspectorSectionField title="Configuration Details">
				...
				<EditorInspectorNumberField noUndoRedo object={this.state.selectedConfiguration} property="width" label="宽度" onChange={() => this._handleChange()} />
				<EditorInspectorNumberField noUndoRedo object={this.state.selectedConfiguration} property="height" label="高度" onChange={() => this._handleChange()} />
				<EditorInspectorNumberField noUndoRedo object={this.state.selectedConfiguration} property="depth" label="深度" onChange={() => this._handleChange()} />
				<EditorInspectorListField
					noUndoRedo
				...
				/>
				<EditorInspectorNumberField noUndoRedo object={this.state.selectedConfiguration} property="min" label="最小值" onChange={() => this._handleChange()} />
				<EditorInspectorNumberField noUndoRedo object={this.state.selectedConfiguration} property="max" label="最大值" onChange={() => this._handleChange()} />
				<EditorInspectorNumberField noUndoRedo object={this.state.selectedConfiguration} property="boxOffset" label="盒体偏移" onChange={() => this._handleChange()} />
				<EditorInspectorListField
					noUndoRedo
					object={this.state.selectedConfiguration}
