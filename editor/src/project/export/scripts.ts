...
import { getScriptAbsolutePath, getScriptImportPathFromScriptsFile, IModelSidecarScriptRecord } from "../../tools/model-sidecar";
		...
		configuration.metadata.scripts?.forEach((script) => {
			promises.push(
				new Promise<void>(async (resolve) => {
					const path = getScriptAbsolutePath(projectPath, script as IModelSidecarScriptRecord);
					...
					scriptsMap[script.key] = getScriptImportPathFromScriptsFile(script as IModelSidecarScriptRecord);
